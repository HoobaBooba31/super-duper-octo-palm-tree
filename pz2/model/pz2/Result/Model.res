...
lifetime=s:rebuild
result=s:1
files=s:Export Farfields to 3DEXPERIENCE Content.rd0
...
parametric=s:P
user_delete=s:1
files=s:3DX\Farfields\Farfield (f=1) [1].ffs
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\E-Field\e-field (f=2) [1]
files=s:e-field (f=2)_1,1.m3d
files=s:e-field (f=2)_1,1_m3d.rex
...
lifetime=s:surviveparchange
result=s:1
treepath=s:Tables\0D Results\Export Farfields to 3DEXPERIENCE Content
files=s:Export Farfields to 3DEXPERIENCE Content.rt0
files=s:Export Farfields to 3DEXPERIENCE Content.rd0
